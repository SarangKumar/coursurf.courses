    ...
    return (
        <motion.div variant={cardVariants} initial='hidden' animate='visible' className={card.card}>
            ...
            <div className={card.bottom}>
                ...
                <h2 className={card.title}>Applied Data Science with Python Specialization</h2>
                ...
                <Splide className={card.courseBadges} options={SplideProps}>
                    ...
                    <SplideSlide className={card.tag}>
                        3-4 Months
                    </SplideSlide>
                    <SplideSlide className={card.tag}>
                        Beginner
                ...
                <Text className={card.desc} noOfLines={7}>
                ...
                <div className={card.btns}>
                    ...
                    <div className={card.price}>{price == 0 ? 'Free' : price + 'INR'}</div>
